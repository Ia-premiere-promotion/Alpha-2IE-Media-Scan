"""
Script pour scraper une seule fois la page Facebook ESidwaya
...
def main():
    """Fonction principale pour scraper ESidwaya"""
    
    print("=" * 70)
    print("🔍 SCRAPING UNIQUE - ESidwaya")
    print("=" * 70)
    
    # Configuration
    email = os.getenv('FB_EMAIL')
    password = os.getenv('FB_PASSWORD')
    # URL de la page ESidwaya
    ...
    # Créer le scraper avec les keywords pour ESidwaya
    page_keywords = ['ESidwaya', 'sidwaya', '100064709527661']
    ...
    if scraper.posts_data:
        output_file = 'esidwaya_posts.json'
